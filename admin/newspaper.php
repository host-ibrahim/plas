...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Insert newspaper data into the database
    $sql = "INSERT INTO Newspapers (title, publisher, publication_date, available_quantity) VALUES ('$title', '$publisher', '$publicationDate', '$availableQuantity')";
...
<body class="sidebar-mini layout-navbar-fixed layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">All Newspapers</h1>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                <div class="card-header d-flex">
                                    ...
                                    <div class="card-tools ml-auto">
                                        <button class="btn btn-primary" data-toggle="modal" data-target="#modal-newspaper">
                                        ...
                                        <tbody>
                                            <?php foreach ($newspapers as $i => $newspaper) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $newspaper['available_quantity'] ?></td>
                                                    <td class="text-center">
                                                        <a href="edit_newspaper.php?id=<?= $newspaper['newspaper_id'] ?>"><span class="fas fa-edit text-primary"></span></a>
                                                        <a href="delete_newspaper.php?id=<?= $newspaper['newspaper_id'] ?>" class="ml-3" onclick="return confirm('Are you sure to delete this newspaper?')">
        ...
        <!-- Add Newspaper Modal -->
        <div class="modal fade" id="modal-newspaper" tabindex="-1" role="dialog" aria-labelledby="modal-newspaper-title" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form action="" method="POST">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modal-newspaper-title">Add New Newspaper</h5>
